...
import MentionLegal from "../pages/public/site/MentionLegal";
import Politique from "../pages/public/site/Politique";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/politiques-confidentialite" element={<Politique />} />
