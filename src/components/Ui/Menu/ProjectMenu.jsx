  ...
  return (
    <div className="flex flex-shrink-0 self-start cursor-pointer">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-custom-700 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="py-1">
              <Menu.Item>
                {({ active }) => (
                  <a
                  ...
                  >
                    <FlagIcon
                      className="mr-3 h-5 w-5 text-gray-100"
                      aria-hidden="true"
                    />
